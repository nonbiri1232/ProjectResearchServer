...
/// <summary>
/// 人間対旧880/101仕様の学習済みML-Agentsのオフライン対戦を管理する。
/// 人間は保存済みDeck1、AIは指定された候補デッキからランダムに使用する。
/// </summary>
public class LegacyAIBattleManager : MonoBehaviour
{
    [Header("References")]
    [SerializeField] private LegacyMlAgents aiAgent;
    [SerializeField] private LegacyAIBattleVisual visual;
    ...
    private void Start()
    {
        ...
        {
            Debug.LogError("LegacyAIBattleManager: aiAgentまたはvisualが設定されていません。");
            enabled = false;
            return;
        }
